    ...
    <div className='relative w-full h-screen bg-login bg-cover'>
      <div className='flex justify-center items-center h-full'>
        <form className='max-w-[400px] w-full mx-auto bg-white p-8 rounded-md'>
          ...
          <Link to={'/Vive-Colegio/categoria'} className='w-full text-2xl block border-2 border-water-blue text-center bg-water-blue hover:bg-white hover:text-water-blue text-white font-semibold rounded-lg px-4 py-3 mt-6'>Iniciar sesion</Link>
        </form>
      </div>
    </div>
  );
